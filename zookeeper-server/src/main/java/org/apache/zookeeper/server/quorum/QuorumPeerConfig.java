...
public class QuorumPeerConfig {
    ...
    protected String configFileStr = null;//启动时用户指定的配置文件路径
    ...
    protected String initialConfig;//整个配置文件原始字符串
    ...
    public void parse(String path) throws ConfigException {
        ...
        //dynamicConfigFileStr是在上一步赋值的，来源于 配置文件的dynamicConfigFile属性
        //看着意思是动态配置信息，可以热加载的？
    ...
    /**
     * 把每一个配置项一个一个解析出来赋值到 this成员变量上，没有设置的赋默认值，校验是否合规，错误的抛异常
